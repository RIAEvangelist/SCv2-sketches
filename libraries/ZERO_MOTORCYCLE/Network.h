...
Define Conversions
\***************/
#define KM_TO_MI .621371
#define MI_TO_KM 1.609343502101154
...
#define TOTAL_MESSAGES 35
#define TOTAL_MESSAGES_DASH 5
#define TOTAL_MESSAGES_CONTROLLER 6
#define TOTAL_MESSAGES_CALEX 9
#define TOTAL_MESSAGES_CALEXMX 2
#define TOTAL_MESSAGES_CCU 2
...
const Message CALEXMX_CHARGE_STATUS={"CALEXMX_CHARGE_STATUS",0x193};
const Message T_CALEXMX_MAX_CHARGE_VOLTAGE_CURRENT={"T_CALEXMX_MAX_CHARGE_VOLTAGE_CURRENT",0x293};

const Message CCU_CHARGE_STATUS={"CCU_CHARGE_STATUS",0x190};
const Message T_CCU_MAX_CHARGE_VOLTAGE_CURRENT={"T_CCU_MAX_CHARGE_VOLTAGE_CURRENT",0x290};
...
const Message Zero_Messages[TOTAL_MESSAGES] = {
  ...
  //2 CALEXMX
  CALEXMX_CHARGE_STATUS,
  T_CALEXMX_MAX_CHARGE_VOLTAGE_CURRENT,

  //2 CCU
  CCU_CHARGE_STATUS,
  T_CCU_MAX_CHARGE_VOLTAGE_CURRENT
};
