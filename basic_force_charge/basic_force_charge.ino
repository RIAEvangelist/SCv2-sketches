...
const unsigned short MAX_C=94; //leave 12A for onboard
const unsigned short GOOD_JAMPS = 31; //calcs use a short so decimal is cut off. so 6.4kw is 30 and 6.6kW is 31
const unsigned short SHIT_JAMPS = 26; //calcs use a short so decimal is cut off. so 5.6kw is 26
const unsigned short MAX_V = 116;
